...
export const cardDefinitions: Card[] = [
	...
	},
	{
		...
		count: 4,
		hasMorePages: true,
		cannotUseText: 'Ты не можешь использовать эту карту, так как у тебя недостаточно карт в руке.',
	...
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Если ты используешь эту карту, следующий вопрос ищеек будет бесплатным. (Это обрабатывается игрой, не забудь записать следующий вопрос.)',
		canUse: (hand) => true,
	},
	{
	...
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, выбранное место отпуска искателей должно быть дальше от тебя, чем текущее местоположение ищеек.',
		canUse: (hand) => true,
	},
	{
	...
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, ты должен отправить ищейкам видео с птицей.',
		canUse: (hand) => true,
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, ищейки должны быть на улице.',
		canUse: (hand) => true,
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, ищейки должны двигаться в неправильном направлении.',
		canUse: (hand) => true,
	},
	{
	...
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, ищейки должны быть в 300 метрах(или ближе) от водоёма.',
		canUse: (hand) => true,
	},
	{
		...
		count: 1,
		hasMorePages: false,
		useText: 'Чтобы использовать эту карту, ты должен отправить ищейкам фото животного.',
		canUse: (hand) => true,
	},
];
